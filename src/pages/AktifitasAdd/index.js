    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyGap jarak={10} />
                <MyInput label="Lokasi *" value={kirim.lokasi} iconname="location" onChangeText={x => setKirim({ ...kirim, lokasi: x })} />
                <MyGap jarak={10} />
                <MyInput label="Aktifitas *" value={kirim.aktifitas} iconname="folder-open" onChangeText={x => setKirim({ ...kirim, aktifitas: x })} />

                <MyGap jarak={10} />
                <MyInput label="Keterangan" value={kirim.keterangan} iconname="create" onChangeText={x => setKirim({ ...kirim, keterangan: x })} />


                <UploadFoto onPress2={() => getGallery(1)} foto={kirim.foto} label="Upload foto" />
